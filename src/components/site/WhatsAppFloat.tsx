...
export default function WhatsAppFloat({ whatsappNumber }: { whatsappNumber: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[60] flex h-14 w-14 items-center justify-center rounded-full border border-or bg-black shadow-[0_12px_30px_rgba(0,0,0,0.5)] md:hidden"
    >
